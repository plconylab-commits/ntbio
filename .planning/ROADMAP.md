...
### Phase 10: 처방전 PDF 파싱 정확도 + 연동 완성

**Goal:** 폴더 내 모든 처방전 PDF가 원본 그대로 처방전.html에 재현되고(셀 분리·단계·평당가), 거래명세표↔처방전 간 쌍방향 연동이 완성된다
**Requirements:** PARSE-10~14, SYNC-01~02
**Plans:** 2 plans

Plans:
- [ ] 10-01-PLAN.md — _COST_KW '평당' 추가(깻잎 평당가 수정) + SYNC-01 안내 토스트
- [ ] 10-02-PLAN.md — 전체 처방전 PDF 브라우저 검증 체크포인트 (PARSE-10~14, SYNC-01~02)
...
| 8. 매출 집계 | v1.1 | 1/1 | Complete   | 2026-03-28 |
| 9. 평당가 페이지 + 이미지 첨부 | v1.1 | 0/2 | 🔲 Planned | — |
| 10. 처방전 PDF 파싱 정확도 + 연동 완성 | v1.1 | 0/2 | 🔲 Planned | — |
